...
Write-Host ""
Write-Host "Install completed. Please run uv run config.py to configure Caption credentials, sidecar naming, and the statusline/usage guard." -ForegroundColor Green
